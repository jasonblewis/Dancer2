...
If you want to run your application behind a proxy that does ssl termination you
will need to set the behind_proxy option in your config. See L<Config> for more information.
